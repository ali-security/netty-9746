...
public class DeleteFileOnExitHookTest {
    ...
    private boolean previousDeleteOnExitTemporaryFile;
    private FileUpload fu;

    @Before
    public void setUp() throws IOException {
        previousBaseDirectory = DiskFileUpload.baseDirectory;
        previousDeleteOnExitTemporaryFile = DiskFileUpload.deleteOnExitTemporaryFile;
        DiskFileUpload.baseDirectory = HOOK_TEST_TMP;
    ...
    public void tearDown() {
        DiskFileUpload.baseDirectory = previousBaseDirectory;
        DiskFileUpload.deleteOnExitTemporaryFile = previousDeleteOnExitTemporaryFile;
    }
